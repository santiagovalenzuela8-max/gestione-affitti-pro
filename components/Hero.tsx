  ...
  return (
    <section id="top" className="relative overflow-hidden bg-paper">
      <div className="mx-auto grid max-w-6xl gap-12 px-6 pb-20 pt-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:pb-28 lg:pt-20">
        <div>
          <p className="inline-flex items-center gap-2 border border-gold-500/40 bg-gold-100/60 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.15em] text-gold-700">
            Verona · Lago di Garda · Trentino
          </p>

          <h1 className="mt-6 max-w-xl font-serif text-4xl leading-[1.1] tracking-tight text-ink text-balance sm:text-5xl lg:text-[3.4rem]">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a
              href="#contatti"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-ink px-7 py-3.5 text-base font-semibold text-paper shadow-lg shadow-ink/15 transition hover:bg-noir-soft"
            >
        ...
        <div className="relative mx-auto aspect-[4/5] w-full max-w-md lg:max-w-none">
          ...
          <div className="absolute left-8 top-14 h-24 w-24 rounded-full bg-gold-500/40 blur-2xl" />
